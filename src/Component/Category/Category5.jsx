...
const ACCENT = "#16244A";
const ACCENT_LIGHT = "#3A4E82";

const PRODUCTS = [
  {
    "name": "Ledger",
    "tagline": "Hardbound A5 Notebook",
    "code": "UG-OF06",
    "price": 349,
    "seed": "office-UG-OF06"
  },
  {
    "name": "Inkline",
    "tagline": "Premium Metal Ballpoint Pen",
    "code": "UG-OF02",
    "price": 249,
    "seed": "office-UG-OF02"
  },
  {
    "name": "DeskMat",
    "tagline": "Vegan Leather Desk Organizer Mat",
    "code": "UG-OF14",
    "price": 899,
    "seed": "office-UG-OF14"
  },
  ...
  {
    "name": "FolderKit",
    "tagline": "Document Organizer Folder Set",
    "code": "UG-OF08",
    "price": 449,
    "seed": "office-UG-OF08"
  },
  {
    "name": "DeskLamp",
    "tagline": "LED Rechargeable Desk Lamp",
    "code": "UG-OF23",
    "price": 1499,
    "seed": "office-UG-OF23"
  },
  {
    "name": "Coaster Set",
    "tagline": "Cork Desk Coaster Set of 4",
    "code": "UG-OF05",
    "price": 299,
    "seed": "office-UG-OF05"
  }
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 py-12 sm:py-16">
          ...
          >
            ...
            <ChevronRight size={13} />
            <span style={{ color: C.goldLight }}>Desk & Office</span>
          </motion.div>
