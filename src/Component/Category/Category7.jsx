...
const ACCENT = "#2F7D46";
const ACCENT_LIGHT = "#5CAE73";

const PRODUCTS = [
  {
    "name": "Hydroflow",
    "tagline": "Stainless Steel Insulated Bottle",
    "code": "UG-EC09",
    "price": 799,
    "seed": "eco-UG-EC09"
  },
  ...
  {
    "name": "StrawKit",
    "tagline": "Reusable Bamboo Straw Set",
    "code": "UG-EC01",
    "price": 249,
    "seed": "eco-UG-EC01"
  },
  {
    "name": "WheatCup",
    "tagline": "Wheat Straw Coffee Cup",
    "code": "UG-EC06",
    "price": 349,
    "seed": "eco-UG-EC06"
  },
  {
    "name": "EcoLunch",
    "tagline": "Bamboo Fiber Lunch Box",
    "code": "UG-EC12",
    "price": 699,
    "seed": "eco-UG-EC12"
  },
  {
    "name": "SeedCard",
    "tagline": "Plantable Seed Greeting Card",
    "code": "UG-EC02",
    "price": 99,
    "seed": "eco-UG-EC02"
  },
  {
    "name": "JuteBag",
    "tagline": "Jute Fabric Grocery Bag",
    "code": "UG-EC08",
    "price": 299,
    "seed": "eco-UG-EC08"
  },
  {
    "name": "BambooBrush",
    "tagline": "Bamboo Handle Cleaning Brush Set",
    "code": "UG-EC04",
    "price": 249,
    "seed": "eco-UG-EC04"
  },
  {
    "name": "SolarLamp",
    "tagline": "Solar Powered Garden Lamp",
    "code": "UG-EC17",
    "price": 999,
    "seed": "eco-UG-EC17"
  }
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 py-12 sm:py-16">
          ...
          >
            ...
            <ChevronRight size={13} />
            <span style={{ color: C.goldLight }}>Eco & Lifestyle</span>
          </motion.div>
