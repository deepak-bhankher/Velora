...
const COLORS = [{"id": "navy", "label": "Navy", "hex": "#0B1B3A"}, {"id": "maroon", "label": "Maroon", "hex": "#7A1F2B"}, {"id": "black", "label": "Black", "hex": "#1C2333"}];

const RELATED = [{"name": "Compact", "code": "UG-BG09", "price": 1399}, {"name": "Weekender", "code": "UG-BG14", "price": 1699}, {"name": "TechSleeve", "code": "UG-BG08", "price": 799}, {"name": "Trekker", "code": "UG-BG17", "price": 1999}];
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 py-6 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <p className="mt-1 text-[13.5px]" style={{ color: "#7A8092" }}>
            Anti-Theft Laptop Backpack · Item Code UG-BG21
          </p>
