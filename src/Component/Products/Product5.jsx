...
const COLORS = [{"id": "navy", "label": "Navy", "hex": "#0B1B3A"}, {"id": "black", "label": "Black", "hex": "#1C2333"}, {"id": "gold", "label": "Gold", "hex": "#C9A227"}];

const RELATED = [{"name": "Inkline", "code": "UG-OF02", "price": 249}, {"name": "DeskMat", "code": "UG-OF14", "price": 899}, {"name": "ClipCase", "code": "UG-OF04", "price": 599}, {"name": "FolderKit", "code": "UG-OF08", "price": 449}];
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 py-6 grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <p className="mt-1 text-[13.5px]" style={{ color: "#7A8092" }}>
            Hardbound A5 Notebook · Item Code UG-OF06
          </p>
